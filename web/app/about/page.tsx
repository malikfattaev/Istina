...
export const metadata: Metadata = {
  title: "О клубе",
  description:
    "Православный молодёжный клуб во имя святых мучениц Веры, Надежды, Любови и матери их Софии при Свято-Успенском кафедральном соборе в Ташкенте. Библия, молитвы, основы веры и статьи - всё в одном месте.",
};
  ...
  return (
    <div>
      ...
      <section className="relative mb-8 flex min-h-[260px] flex-col justify-end overflow-hidden rounded-3xl border border-sand-200 sm:min-h-[340px]">
        ...
        <div className="relative p-6 sm:p-10">
          ...
          <p className="mt-2 max-w-2xl leading-relaxed text-white/85">
            Православный молодёжный клуб во имя святых мучениц Веры, Надежды,
      ...
      <div className="space-y-4 leading-relaxed text-sand-700">
        <p>
          Православный молодёжный клуб во имя святых мучениц Веры, Надежды,
          Любови и матери их Софии при Свято-Успенском кафедральном соборе
          (Собор Успения Божией Матери) в Ташкенте. Это команда молодых
          ребят, которые живут верой и хотят быть полезными храму и людям.
        </p>
        <p>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 leading-relaxed text-sand-700">
          Наш ПМК - это не только встречи и выезды. Сайт клуба сам по себе
