...
export const metadata: Metadata = {
  ...
  title: {
    default: "Православный молодёжный клуб «Истина»",
    template: "%s | Истина",
  },
  description:
    "Православный молодёжный клуб «Истина» при Свято-Успенском кафедральном соборе в Ташкенте: новости, события, выезды, благотворительность и добрые дела.",
  openGraph: {
    type: "website",
    locale: "ru_RU",
    siteName: "Православный молодёжный клуб «Истина»",
  },
};
